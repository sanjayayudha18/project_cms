...
// Full-color tokens use var() directly; accept the v3 shadcn wrapper too.
function normalizeLegacyChartColor(color) {
  return color?.replace(/^hsl\(var\((--[$\w-]+)\)\)$/, "var($1)");
}
...
${colorConfig.map(([key, itemConfig]) => {
          const color = normalizeLegacyChartColor(
