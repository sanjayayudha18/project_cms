...
VALUES (sqlc.arg('code'), sqlc.arg('name'), sqlc.narg('legal_name'), sqlc.narg('npwp'),
        sqlc.narg('contact_email'), sqlc.narg('contact_phone'), sqlc.narg('hq_address'))
...
SET name = sqlc.arg('name'),
    legal_name = sqlc.narg('legal_name'),
    npwp = sqlc.narg('npwp'),
