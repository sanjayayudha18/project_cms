 ...
 *
 * @example formatIDR(18_420_000_000_000) // "IDR 18.4T"
 * @example formatIDR(12_800_000_000) // "IDR 12.8B"
 * @example formatIDR(125_000_000) // "IDR 125.0M"
 * @example formatIDR(50_000) // "IDR 50000"
 */
 ...
 *
 * @example formatFullDate(new Date('2026-07-21')) // "Tuesday, 21 July 2026"
 */
 ...
 *
 * @example formatBadgeCount(0) // null
 * @example formatBadgeCount(5) // "5"
 * @example formatBadgeCount(150) // "99+"
 * @example formatBadgeCount(-1) // null
 */
 ...
 *
 * @example formatDifference(-125000000) // { text: "- IDR 125.000.000", colorClass: "text-danger" }
 * @example formatDifference(50000000) // { text: "+ IDR 50.000.000", colorClass: "text-success" }
 * @example formatDifference(0) // { text: "IDR 0", colorClass: "" }
 */
