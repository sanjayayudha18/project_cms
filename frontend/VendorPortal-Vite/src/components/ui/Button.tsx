...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  ghost: "text-sidebar-active hover:bg-sidebar-active/10 focus-visible:outline-sidebar-active",
  danger: "bg-danger-fg text-white hover:bg-danger-fg/90 focus-visible:outline-danger-fg",
};
